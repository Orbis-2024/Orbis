...
class CustomSlider3 extends Component {
  ...
  render() {
    ...
    const effectiveSlideValue = slideValue >= 9 ? 9 : slideValue;

    // Calculăm lățimea slider-ului real
    const sliderRealWidth = (effectiveSlideValue / 10) * sliderWidth;

    // Poziționăm thumb-ul
    const thumbLeft = (effectiveSlideValue / 10) * sliderWidth - thumbSize / 2;
