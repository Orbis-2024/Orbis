...
class CustomSlider3 extends Component {
  ...
  render() {
    ...
    const effectiveSlideValue = slideValue >= 1400 ? 1400 : slideValue;

    // Calculăm lățimea slider-ului real
    const sliderRealWidth = (effectiveSlideValue / 1500) * sliderWidth;

    // Poziționăm thumb-ul
    const thumbLeft =
      (effectiveSlideValue / 1500) * sliderWidth - thumbSize / 2;
