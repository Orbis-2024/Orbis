...
class CustomSlider extends Component {
  ...
  render() {
    ...
    const effectiveSlideValue = slideValue >= 10 ? 9 : slideValue;
    ...
    const sliderRealWidth = ((effectiveSlideValue - 1) / 9) * sliderWidth;
    const thumbLeft =
      ((effectiveSlideValue - 1) / 9) * sliderWidth - thumbSize / 2;
