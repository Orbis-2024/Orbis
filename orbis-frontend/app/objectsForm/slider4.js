...
class CustomSlider4 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      slideValue: 0,
  ...
  render() {
    ...
    const effectiveSlideValue = slideValue >= 700 ? 700 : slideValue;

    // Calculăm lățimea slider-ului real
    const sliderRealWidth = (effectiveSlideValue / 800) * sliderWidth;

    // Poziționăm thumb-ul
    const thumbLeft = (effectiveSlideValue / 800) * sliderWidth - thumbSize / 2;
