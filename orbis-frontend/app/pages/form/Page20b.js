...
import CustomSlider from "../../assets/sliderP20";
...
export default function Page_20b() {
  ...
  const handleBack = (index) => {
    console.log("Question 20b: revoked");
    index = 0;
    navigation.navigate("Page 20a");
  };
  ...
  handleContinue = (index) => {
    const updatedResponses = [
      ...userResponses,
      { questionID: 26, answer: index },
    ];
    const updateEmission = co2Emission + slideValue * 1000 * 0.18;
    console.log("CO2 Emission in Page20b:", co2Emission);
    navigation.navigate("Page 20c", {
            ...
            <View style={styles.page}>
              <View style={styles.title}>
                <Text style={styles.question}>
                  How many mid-range flights (lasting between 3 and 6 hours) do
                  you take annually?
                </Text>
              </View>
