...
export default function Page_20a() {
  ...
  const handleBack = (index) => {
    console.log("Question 20a: revoked");
    index = 0;
  ...
  handleContinue = (index) => {
    const updatedResponses = [
      ...userResponses,
      { questionID: 20, answer: index },
    ];
    const updateEmission = co2Emission + slideValue * 500 * 0.24;
    console.log("CO2 Emission in Page20a:", co2Emission);
            ...
            <View style={styles.page}>
              <View style={styles.title}>
                <Text style={styles.question}>
                  How many short-ranged flights (less than 3 hours long) do you
                  take annually?
                </Text>
              </View>
