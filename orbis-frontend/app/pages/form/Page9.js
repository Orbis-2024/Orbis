...
import CustomSlider from "../../assets/sliderP9";
...
export default function Page_9() {
  ...
  handleContinue = (index) => {
    const updatedResponses = [
      ...userResponses,
      { questionID: 9, answer: slideValue },
    ];
    if (slideValue <= 30) {
      co2Emission += 100;
      ...
      co2Emission += 300;
    } else if (slideValue <= 150) {
      co2Emission += 500;
    } else if (slideValue >= 151) {
      co2Emission += 700;
    }
    console.log("Question 9:", index);
    console.log(co2Emission);
    navigation.navigate("Page 10", {
              ...
              <View style={styles.page}>
                <View style={styles.title}>
                  <Text style={styles.question}>
                    What is the size of your home?(sqm)
                  </Text>
                </View>
