...
import CustomSlider from "../../objectsForm/slider";
...
export default function Page8() {
  ...
  const handleContinue = () => {
    const updatedResponses = [
      ...userResponses,
      { questionID: 8, answer: slideValue }, // Add new response to userResponses
    ];
    co2Emission += 100 * slideValue;
  ...
  const handleBack = (index) => {
    console.log("Question 8: revoked");
    index = 0;
