...
import CustomSlider3 from "../../objectsForm/slider3";
...
export default function Page14() {
  ...
  const handleContinue = () => {
    const updatedResponses = [
      ...userResponses,
      { questionID: 14, answer: slideValue }, // Add new response to userResponses
    ];
    co2Emission += slideValue * 10;
    console.log("Page X - CO2 Emission:", co2Emission);
    navigation.navigate("Page 15", {
            ...
            <Animated.View style={[{ opacity: fadeAnim }, styles.animatedView]}>
              <View style={styles.page}>
                ...
                <View style={styles.chartsize}>
                  <CustomSlider3 onSlideValueChange={setSlideValue} />
                </View>
