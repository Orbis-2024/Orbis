...
export default function Page_20c() {
  ...
  const handleBack = (index) => {
    console.log("Question 20c: revoked");
    index = 0;
    navigation.navigate("Page 20b");
  };
  ...
  handleContinue = (index) => {
    const updatedResponses = [
      ...userResponses,
      { questionID: 27, answer: index },
    ];
    const updateEmission = co2Emission + slideValue * 1500 * 0.15;
    console.log("CO2 Emission in Page20c:", co2Emission);
    navigation.navigate("Page 21", {
            ...
            <View style={styles.page}>
              <View style={styles.title}>
                <Text style={styles.question}>
                  How many long-range flights (over 6 hours long) do you take
                  annually?
                </Text>
              </View>
